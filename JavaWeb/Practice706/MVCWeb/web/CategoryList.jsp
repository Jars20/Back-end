<%@ page import="club.banyuan.entity.User,club.banyuan.entity.Product" %>
        ...
        <span class="fr">
        	<span class="fl"><%
                ...
                if(object_1 != null){
                    ...
                    out.print("欢迎，<a href='Member_User.jsp' style='color:#ff4e00;'>" + user.getLoginName()+"</a>");
                }
                else{
...
<div class="top">
    ...
    <div class="search">
    	<form id="search" method="post" action="search_product.do">
                    ...
                    <%
                        ...
                        if (object!=null){
                            ...
                            for (Product product : productList) {
                                out.print("<li>\n" +
                                        "                        <div class=\"img\"><a href=\"productDetail.do?id="+product.getId()+"\"><img src=\"images/per_1.jpg\" width=\"210\" height=\"185\" /></a></div>\n" +
                                        "                        <div class=\"price\">\n" +
