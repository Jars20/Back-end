        ...
        <span class="fr">
        	 <span class="fl">
              <%
                  ...
                  Object object_1 = session.getAttribute("user");
                  if (object_1 != null) {
                ...
                <div class="des_join">
                    ...
                    <span class="fl" ><%
                        if(registerFlag==false){
                            out.print("<a onclick=\"ShowDiv_1('MyDiv1','fade1')\">\n" +
                                    "                        <img src=\"images/j_car.png\"/></a>");
                        }else {
                            out.print("                    <input type=\"image\" src=\"images\\j_car.png\"/>\n");
                        }
                    %></span>
                </div>
            </form>
            ...
            <div class="des_border">
                ...
                <div class="des_con" id="p_attribute">
                    ...
                    <table border="0" align="center" style="width:100%; font-family:'宋体'; margin:10px auto;"
                        ...
                        <tr>
                            <td>商品名称：<%=product.getName()%>
                            </td>
                            <td>商品编号：<%=product.getId()%>
                            </td>
                            <td>品牌： 迪奥（Dior）</td>
...
<%--                        <td width="40"><img src="images/suc.png"/></td>--%>
                        <td>
                            <span style="color:#3e3e3e; font-size:18px; font-weight:bold;">请先登录再进行购物车操作！</span><br/>
...
<%--                                    kind++;--%>
<%--                                    num += cart.get(product1);--%>
<%--                                    totalCost += num * product1.getPrice();--%>
<%--                                }--%>
<%--                                out.print("购物车共有"+kind+"种宝贝（"+num+"件） &nbsp; &nbsp; 合计："+totalCost+"元");--%>
<%--                            %>--%>
                        </td>
                    </tr>
                    <tr height="50" valign="bottom">
                        <td>&nbsp;</td>
                        <td>
<%--                            <a href="BuyCar.jsp" class="b_sure">去购物车结算</a>--%>
<%--                            <a href="index.jsp" class="b_buy">继续购物</a>--%>
                        </td>
                    </tr>
                </table>
